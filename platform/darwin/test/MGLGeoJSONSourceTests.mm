...
- (void)testMGLGeoJSONSourceWithDataMultipleFeatures {
    ...
    XCTAssertNotNil(source.feature);
#warning - MGLPolylineFeature doesn't round-trip
    //XCTAssertTrue([source.feature isMemberOfClass:[MGLPolylineFeature class]]);
    XCTAssertTrue([source.feature isMemberOfClass:MGLShapeCollectionFeature.class]);
}
...
- (void)testMGLGeoJSONSourceWithPolygonFeatures {
    ...
    XCTAssertNotNil(source.feature);
    MGLPolygonFeature *expectedPolygonFeature = (MGLPolygonFeature *)source.feature;
...
- (void)testMGLGeoJSONSourceWithPolygonFeaturesInculdingInteriorPolygons {
    ...
    XCTAssertNotNil(source.feature);
    XCTAssertTrue([source.feature isMemberOfClass:[MGLPolygonFeature class]]);
}
...
- (void)testMGLGeoJSONSourceWithMultiPolylineFeatures {
    ...
    XCTAssertNotNil(source.feature);
    XCTAssertTrue([source.feature isMemberOfClass:[MGLMultiPolylineFeature class]]);
}
...
- (void)testMGLGeoJSONSourceWithMultiPolygonFeatures {
    ...
    XCTAssertNotNil(source.feature);
    XCTAssertTrue([source.feature isMemberOfClass:[MGLMultiPolygonFeature class]]);
}
...
- (void)testMGLGeoJSONSourceWithPointFeature {
    ...
    XCTAssertNotNil(source.feature);
    XCTAssertTrue([source.feature isMemberOfClass:[MGLPointFeature class]]);
}
...
- (void)testMGLGeoJSONSourceWithPointCollectionFeature {
    ...
    XCTAssertNotNil(source.feature);
    XCTAssertTrue([source.feature isMemberOfClass:[MGLPointCollectionFeature class]]);
}
